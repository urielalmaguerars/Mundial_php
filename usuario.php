...
while ($img = $resImg->fetch_assoc()) {
    ...
    $imagenes[] = "data:image/" . $img["tipo"] . ";base64," . $base64;
    $idPublicacion = $row["id_publicacion"];

}


// Publicaciones aprobadas VISTA
...
.nav-links {
    ...
    flex: 1; /* 🔥 Ocupa el espacio disponible para mantenerse centrado */
}
.nav-links a {
...
<header>
    ...
    <nav class="nav-links" id="nav-links">
        ...
        <a href="infografia.php">Mundiales</a>
        <a href="info_paises.php">Países</a>
        <a href="subir.php">Subir Post</a>
    </nav>

<!-- Barra de búsqueda -->

<form class="search-bar" id="search-bar" method="POST" action="usuario.php">
    <input class="form-control me-2" name="query" 
    onkeyup="consulta_buscador($('#buscar').val());"  
    id="buscar" placeholder="Buscar usuario..." required>
</form>

<!-- ✅ Contenedor de resultados -->
<div id="resultados-busqueda" style="display:none;">
    <ul class="lista-resultados" id="lista-usuarios"></ul>
</div>
    ...
    <div class="header-right">
        <a href="#" id="search-btn">
            <img src="serch.png" alt="Buscar">
        </a>
        <a href="perfil.php">
            <img src="Person_icon.png" alt="Perfil">
        </a>
    </div>
</header>
...
<section id="infografia">
    ...
    <a href="infografia.php" class="btn fade-up">Ver más</a>
</section>
...
<section id="paises">
    ...
    <a href="info_paises.php" class="btn fade-up">Ver más</a>
</section>
...
<section id="nuevo">
    ...
    <div class="posts-grid">
        ...
        <div class="post fade-up">
            ...
            <button onclick="darLike(<?php echo $idPublicacion; ?>)" id="like-btn-<?php echo $idPublicacion; ?>" class="like-btn fade-up">
                ❤️ Me gusta <?php echo $likesCount; ?>
            </button>
            ...
            <form method="POST" action="comentario.php" class="fade-up">
                <input type="hidden" name="id_publicacion" value="<?php echo $idPublicacion; ?>">
    ...
    <a href="publicacion.php" class="btn fade-up">Ver más</a>
...
<script>
function consulta_buscador(valor) {
    if(valor.trim() === ""){
